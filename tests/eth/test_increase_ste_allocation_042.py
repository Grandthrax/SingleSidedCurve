...
def test_increase_ste_allocation_042(
    live_yvweth_042,
    gov,
    ste_strategy_clone_042,
    seth_strategy_clone_042,
    old_steth_strategy_042,
    old_seth_strategy_042,
):
    live_yvweth_042.migrateStrategy(
        old_steth_strategy_042, ste_strategy_clone_042, {"from": gov}
    )
    ...
    live_yvweth_042.updateStrategyDebtRatio(
        ste_strategy_clone_042, 2_000, {"from": gov}
    )
